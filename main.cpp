...
int main(int numArguments, char **arguments)
{
    ...
    CelestialBody &sun = solarSystem.createCelestialBody( vec3(3.569552387089993E-03, 3.395883113303513E-03, -1.598805663679657E-04), vec3(-1.978871917569178E-06, 6.843726881579374E-06, 4.032140462891743E-08)*365., 1.0 );
...
//    ofstream m_file;
//    string filename = "perihelion_newton.txt";
//    if(m_file.good()) {
